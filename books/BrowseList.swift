...
class BrowseList {
    ...
    var section = [
        ...
        BrowseSectionList ( name: "Romance", imageName: "romance"),
        BrowseSectionList ( name: "Sci-Fi & Fantasy", imageName: "fantasy"),
        BrowseSectionList ( name: "Travel & Adventure", imageName: "travel"),
        BrowseSectionList ( name: "Young Adult", imageName: "young"),
